function _precompile_()
    ...
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(Plm),UnitRange{Int64},Int64,Array{Float32,1}})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(Plm),UnitRange{Int64},Int64,Float32})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(Plm),UnitRange{Int64},UnitRange{Int64},Array{Float32,1}})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(Plm),UnitRange{Int64},UnitRange{Int64},Float32})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(λlm),UnitRange{Int64},Int64,Array{Float32,1}})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(λlm),UnitRange{Int64},Int64,Float32})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(λlm),UnitRange{Int64},UnitRange{Int64},Array{Float32,1}})
    precompile(Tuple{typeof(Base.Broadcast.broadcasted),typeof(λlm),UnitRange{Int64},UnitRange{Int64},Float32})
    precompile(Tuple{typeof(Plm),Int64,Int64,Float32})
    ...
    precompile(Tuple{typeof(λlm),Int64,Int64,Float32})
end
